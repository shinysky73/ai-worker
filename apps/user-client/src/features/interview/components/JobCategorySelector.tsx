...
const CATEGORIES: { value: JobCategory; label: string; icon: ReactNode }[] = [
  {
    value: '개발',
    label: '개발',
    icon: (
    ...
    <div className="grid grid-cols-3 sm:grid-cols-6 gap-2">
      {CATEGORIES.map((cat) => (
        <button
          ...
          disabled={disabled}
          className={`flex flex-col items-center gap-1.5 px-3 py-2.5 rounded-xl border text-xs font-medium transition-all duration-150 ${
            value === cat.value
